...
%changelog
* Sat Dec 13 2025 Bryant Niederriter <43710787+ntnayrb@users.noreply.github.com>
- add %configure --disable-native-tests so that the final binary will run on x86_64-v2
- 

* Sat Dec 13 2025 ntnayrb 1.9.0-3
